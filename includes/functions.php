 ...
 * Log activity
 */
function logActivity($userId, $action, $targetTitle = null, $details = null)
{
    global $pdo;
    $stmt = $pdo->prepare("INSERT INTO activity_logs (user_id, action, target_title, details) VALUES (?, ?, ?, ?)");
    $stmt->execute([$userId, $action, $targetTitle, $details]);
}
