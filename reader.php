...
<head>
    ...
    <title>
        <?= htmlspecialchars($file['title']) ?> — Quezon City Public Library
    </title>
...
<body class="theme-dark">
    ...
    <div class="reader-top" id="readerTop">
        <div class="chrome-left">
            <a href="<?= APP_URL ?>/public.php" class="back-link" title="Back">
